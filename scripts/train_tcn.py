...
def main() -> None:
    parser = argparse.ArgumentParser(description="Train TCN with LOSO protocol")
    ...
    for test_subject in subjects:
        ...
        model = TCNModel(in_channels=dataset.in_channels, num_classes=dataset.num_classes, device=str(device))
        ...
        best_loss = float("inf")
        epochs_no_improve = 0
        best_path = output_dir / f"best_tcn_subject_{test_subject}.pth"
